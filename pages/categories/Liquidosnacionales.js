...
export default function Categories({ categoryProducts }) {
  ...
  const predefinedBrands = ["Jack Vaper", "The Alchemist", "Madness"]; // Marcas predefinidas
                  ...
                  <div className="group block overflow-hidden border border-accent rounded-xl border-opacity-10">
                    <div className="">
                      ...
                      <div className="relative p-3 border-t">
                        ...
                        <div className="mt-1.5 space-x-4 flex items-center justify-between text-text">
                          ...
                          <button
                            ...
                            className={`flex items-center divide-x rounded-lg border border-bgWolf bg-white text-center text-md font-medium text-secondary-700 shadow-sm hover:bg-bgWolf ${isProductInCart(product._id) ? 'cursor-not-allowed opacity-50' : ''}`}
                          >
                            <div className="flex items-center space-x-3 py-2.5 px-1">
